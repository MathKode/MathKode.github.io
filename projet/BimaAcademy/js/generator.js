...
function generate() {
    ...
    const balise_all = {
        ...
        "[/YOUTUBE]": '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
function json_generate() {
    ...
    var ladate=new Date()
    i5 = prompt(`Date du jour [${ladate.getDate()+"/"+(ladate.getMonth()+1)+"/"+ladate.getFullYear()}]`,ladate.getDate()+"/"+(ladate.getMonth()+1)+"/"+ladate.getFullYear())
    tag_ls = []
    ok=true
    while (ok) {
